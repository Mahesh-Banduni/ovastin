...
export default function WhoWeAre() {
    return(
        <div className="section-container flex items-center justify-center relative section-padding pt-0!">
            <div className="max-w-7xl flex flex-col lg:flex-col items-start justify-center gap-scale-md-15">
                <div className="w-full lg:min-w-xl h-full xl:min-w-3xl flex flex-col lg:flex-row items-start justify-center gap-6 sm:gap-7 md:gap-8 lg:gap-50 xl:gap-60">
                    <div className="flex flex-col items-start justify-center w-full lg:min-w-xl">
                        ...
                        <h2 className="mb-scale-md-8">Building dreams one <br/> home at a time</h2>
                    ...
                    <div className="gap-scale-md-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 w-auto lg:max-w-[340px]">
                        {iconList.map((item, index)=>(
                            <div key={index} className="flex flex-col gap-scale-sm-3 w-full">
                                <span className="flex gap-scale-sm-2.5 items-center w-full">
                ...
                <div className="w-full h-full flex flex-col md:flex-row items-start justify-center gap-scale-md-10">
                    ...
                    <div className="grid grid-cols-1 min-[400px]:grid-cols-2 md:grid-cols-1 items-center justify-center gap-0 w-full h-full">
                        {counterList.map((item, index)=>(
                            <div key={index} className="flex flex-col items-center justify-center gap-scale-sm-3 p-scale-md-8 border border-gray-300 first:rounded-t-2xl last:rounded-b-2xl w-full">
