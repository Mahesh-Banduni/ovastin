...
const isValidUrl = (value: string): boolean => {
  try {
    ...
    // Allow normal web URLs and uploaded image data URIs generated by the
...
const optionalUrlField = (label: string) =>
  z.union([
    z.custom<any>((val) => typeof File !== "undefined" && val instanceof File, {
...
export const amenityFormSchema = z.object({
  ...
  icon: optionalUrlField("Amenity image URL"),
...
export const serviceFormSchema = z.object({
  ...
  slug: requiredText("Slug", 200),
  icon: optionalUrlField("Icon image URL"),
