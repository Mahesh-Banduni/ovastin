        ...
        <div className="py-15 md:py-18 lg:py-20 xl:py-25 flex flex-col items-center justify-center">
            ...
            <div className="w-auto px-4">
              {awardsList.map((item,index)=>(
                  <div className="relative group border-2 border-gray-100 first:rounded-t-2xl last:rounded-b-2xl w-full px-6 sm:px-8 md:px-10 lg:px-13 xl:px-15 py-5 md:py-6 lg:py-7 bg-transparent hover:bg-[var(--color-brand-bright)] transition-all duration-300 ease-in-out">
