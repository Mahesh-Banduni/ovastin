...
export default function Header(){
    ...
    return(
        <div className="sticky top-0 z-40 bg-transparent w-full h-auto flex items-center justify-center">
            <div className="container bg-white flex flex-row items-center justify-between px-8! py-5 w-full relative rounded-full border-2 border-gray-100 shadow-sm shadow-gray-50 my-1 md:my-1.25 lg:my-1.5 mx-2! md:mx-2.5! lg:mx-3!">
                ...
                <div className="inline-flex gap-5 items-center justify-center">
                    <Button text="Get Started" variant="primary" className="hidden sm:flex"/>
